...
public class StateController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (EventManager.Instance != null)
        {
            ...
            EventManager.Instance.OnMoveRequested.Subscribe(HandleMoveRequest);  // 新增：处理移动事件
    ...
    public void ChangeState(CharacterStateEnum newState)
    {
        ...
        if (_character != null)
        {
            ...
            if (newState == CharacterStateEnum.Jump )
            {
    ...
    private void HandleDamageRequest(Vector3 attackerPosition)
    {
        ...
        if (_character.IsActionIgnored(ActionIgnoreTag.Damage))
            return;
        if (_character.IsGrounded)
        {
